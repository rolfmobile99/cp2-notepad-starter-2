...
- The “Add Note” button works much like the Previous and Next buttons from the image carousel: it just calls the addNote function when clicked. (This connection is set up by line 18: addEventListener("click", addNote).)
